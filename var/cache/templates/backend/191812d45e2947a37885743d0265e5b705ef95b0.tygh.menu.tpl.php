<?php /* Smarty version Smarty-3.1.21, created on 2020-08-01 14:39:36
         compiled from "C:\xampp\htdocs\cs-cart\design\backend\templates\menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5396615635f2554786f8d17-44578718%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '191812d45e2947a37885743d0265e5b705ef95b0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cs-cart\\design\\backend\\templates\\menu.tpl',
      1 => 1583399261,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5396615635f2554786f8d17-44578718',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_5f255478837509_07128325',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f255478837509_07128325')) {function content_5f255478837509_07128325($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cs-cart/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cs-cart/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:/xampp/htdocs/cs-cart/app/functions/smarty_plugins\\modifier.truncate.php';
if (!is_callable('smarty_modifier_sizeof')) include 'C:/xampp/htdocs/cs-cart/app/functions/smarty_plugins\\modifier.sizeof.php';
?><?php
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            ...
            <div class="nav-ult">
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['are_all_storefronts_closed']) {?>
                    <?php if ($_smarty_tpl->tpl_vars['storefront_status_icon']->value&&fn_check_view_permissions("companies.manage","GET")) {?>
                        <a class="brand" target="_blank" href="<?php echo htmlspecialchars(fn_url("companies.manage"), ENT_QUOTES, 'UTF-8');?>
" title="<?php echo $_smarty_tpl->__("no_active_storefronts");?>
"><i class="icon-shopping-cart icon-white cm-tooltip"></i></a>
                    <?php } else { ?>
                        <p class="brand"><i class="icon-shopping-cart icon-white cm-tooltip"></i></p>
                    <?php }?>
                <?php } else { ?>
