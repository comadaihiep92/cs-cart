<?php /* Smarty version Smarty-3.1.21, created on 2020-08-01 14:39:38
         compiled from "C:\xampp\htdocs\cs-cart\design\backend\templates\views\settings\store_mode.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11805739595f25547a28c597-54073844%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79941e565d6bf5b34319d52d64c9d2e9e14395ea' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cs-cart\\design\\backend\\templates\\views\\settings\\store_mode.tpl',
      1 => 1583423433,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11805739595f25547a28c597-54073844',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f25547a2d8391_85235470',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f25547a2d8391_85235470')) {function content_5f25547a2d8391_85235470($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cs-cart/app/functions/smarty_plugins\\block.inline_script.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('store_mode','choose_your_store_mode','full','product_state_description.','license_number','please_enter_license_here','licensed_product','trial_mode_ult_disabled','trial_mode_mve_disabled','select'));
?>
...
:</label>
                    <input type="text" name="license_number" class="<?php if ($_smarty_tpl->tpl_vars['store_mode_errors']->value) {?> type-error<?php }?>" value="NULLED-BY-MORPHEUS" placeholder="<?php echo $_smarty_tpl->__("please_enter_license_here");?>
">
                    <?php if ($_smarty_tpl->tpl_vars['store_mode_license']->value&&!$_smarty_tpl->tpl_vars['store_mode_errors']->value&&$_smarty_tpl->tpl_vars['store_mode']->value!="ULTIMATE") {?>
                        <p>
...
: <?php echo htmlspecialchars(fn_get_licensed_mode_name($_smarty_tpl->tpl_vars['store_mode']->value), ENT_QUOTES, 'UTF-8');?>
                ...
                <li class="<?php if ($_smarty_tpl->tpl_vars['store_mode']->value=="trial") {?>active<?php } elseif ($_smarty_tpl->tpl_vars['store_mode']->value!="new") {?>disabled<?php }?>">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['store_mode']->value!="new"&&$_smarty_tpl->tpl_vars['store_mode']->value!="ULTIMATE") {?>
