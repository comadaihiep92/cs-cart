        ...
        <span class="choice-text">{__("choose_your_store_mode")}:</span>
            ...
            <ul class="store-mode inline">
                <li class="clickable {if $store_mode_errors} type-error{/if} item{if $store_mode != "trial"} active{/if}">
                    ...
                    <input type="text" name="license_number" class="{if $store_mode_errors} type-error{/if}" value="NULLED-BY-MORPHEUS" placeholder="{__("please_enter_license_here")}">
                    {if $store_mode_license && !$store_mode_errors && $store_mode != "ULTIMATE"}
                        <p>
                ...
                <li class="{if $store_mode == "trial"}active{elseif $store_mode != "new"}disabled{/if}">
                    ...
                    {if $store_mode != "new" && $store_mode != "ULTIMATE"}
