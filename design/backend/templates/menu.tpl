        ...
        {if "ULTIMATE"|fn_allowed_for}
            ...
            <div class="nav-ult">
                ...
                {if $runtime.are_all_storefronts_closed}
                    {if $storefront_status_icon && fn_check_view_permissions("companies.manage", "GET")}
                        <a class="brand" target="_blank" href="{"companies.manage"|fn_url}" title="{__("no_active_storefronts")}"><i class="icon-shopping-cart icon-white cm-tooltip"></i></a>
                    {else}
